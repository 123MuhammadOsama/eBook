...
const Process = () => {
  return (
    <div className='px-32 py-20 space-y-10'>
      <div className='w-1/2'>
        <h1 className='text-4xl font-bold pb-5'>Our <span className='text-red-500'>Unbeatable</span>Process</h1>
        <p>At The Nation Publishers, we&apos;re known for delivering top-notch content writing services. Now, you can dive into the perks of our ghostwriting service too! There are plenty of areas where you can tap into our expertise to get high-quality content. Let&apos;s get started!</p>
      </div>
      ...
      <div className='flex'>
        {/* left Cards */}
         ...
         <div className='space-y-10 top-0 right-0'>
                    {/* first */}
            <div className='bg-black text-white px-2 py-8 w-80'>
         ...
         <div className='space-y-10 top-0 left-0'>
                    {/* first */}
            <div className='bg-black text-white px-2 py-8 w-80 '>
                <div className='flex gap-4 items-center'>
